    ...
    <?php else: ?>
        ...
        <head>
            <title><?php print $head_title; ?></title>
                <meta name="google-site-verification" content="pS3QllBhzpIM2ltNMZlq7GIAFh2iR-cDi6LaFMAXnss" />
        ...
        <body<?php print $attributes; ?>>
          <div class="wrapper">
            ...
            <?php //require_once('_google_analytics.php') ?>
        </body>
    </html>
